...
def search_data(data):
    ...
    try:
        ...
        for i in range(len(data)):
            if search == data[i][1]:
                temp = True
                print("학과 :", data[i][0], "학번 :", data[i][1], "이름 :", data[i][2], "국어 점수 :", data[i][3], "영어 점수 :",
                      data[i][4], "수학 점수 :", data[i][5], "총점 :", data[i][6], "평균 :", data[i][7], "학점 :", data[i][8])
                break
        if not temp:
            print("검색에 실패하였습니다.")
    except:
...
def print_data(data):
    print("===========================")
    for i in range(len(data)):
        print("학과 :", data[i][0], "학번 :", data[i][1], "이름 :", data[i][2], "국어 점수 :", data[i][3], "영어 점수 :", data[i][4],
              "수학 점수 :", data[i][5], "총점 :", data[i][6], "평균 :", data[i][7], "학점 :", data[i][8])
